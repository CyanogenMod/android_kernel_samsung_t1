/* arch/arm/mach-omap2/board-espresso-muxset-r00.c
 *
...
static struct omap_muxtbl muxtbl[] __initdata = {
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     40, "2M_nSTBY"),
	/* [-N-C-] gpmc_a17 - gpio_41 - NC */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     GPMC_A17, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN,
		     41, "gpmc_a17.nc"),
	/* [-----] gpmc_a18 - gpio_42 - LCD_SELECT(nc) */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
	...
	/* [--OUT] gpmc_nbe0_cle - gpio_59 - USB_SEL1 */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     62, "FUEL_SDA_1.8V"),
	/* [-----] gpmc_wait2 - gpio_100 - eMMC_EN(nc) */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     GPMC_WAIT2, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN,
		     100, "eMMC_EN(nc)"),
	/* [-N-C-] gpmc_ncs4 - gpio_101 - NC */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     66, "ADC_I2C_SDA_1.8V"),
	/* [-----] csi21_dx0 - gpi_67 - 2M_CLK_P */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     CSI21_DX0,
		     OMAP_MUX_MODE0 | OMAP_PIN_INPUT | OMAP_PIN_OFF_OUTPUT_LOW,
		     67, "2M_CLK_P"),
	/* [-----] csi21_dy0 - gpi_68 - 2M_CLK_N */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     CSI21_DY0,
		     OMAP_MUX_MODE0 | OMAP_PIN_INPUT | OMAP_PIN_OFF_OUTPUT_LOW,
		     68, "2M_CLK_N"),
	/* [-----] csi21_dx1 - gpi_69 - 2M_DP */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     CSI21_DX1,
		     OMAP_MUX_MODE0 | OMAP_PIN_INPUT | OMAP_PIN_OFF_OUTPUT_LOW,
		     69, "2M_DP"),
	/* [-----] csi21_dy1 - gpi_70 - 2M_DN */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     CSI21_DY1,
		     OMAP_MUX_MODE0 | OMAP_PIN_INPUT | OMAP_PIN_OFF_OUTPUT_LOW,
		     70, "2M_DN"),
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     91, "MIPI_HSI_RX_RDY"),
	/* [-N-C-] usbb1_ulpitll_dat4 - gpio_92 - NC */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     USBB1_ULPITLL_DAT4,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     121, "ACC_INT2"),
	/* [-----] abe_dmic_din3 - gpio_122 - ACC_INT */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     135, "LCD_EN"),
	/* [--OUT] mcspi1_simo - gpio_136 - LVDS_nSHDN */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     OMAP_PIN_OFF_WAKEUPENABLE,
		     142, "TA_nCHG"),
	/* [-----] uart3_rx_irrx - gpio_143 - AP_FLM_RXD(nc) */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     UART3_RX_IRRX, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN,
		     143, "AP_FLM_RXD(nc)"),
	/* [-----] uart3_tx_irtx - gpio_144 - AP_FLM_TXD(nc) */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     153, "2M_nRST"),
	/* [--OUT] mcspi4_cs0 - gpio_154 - IRDA_EN */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     OMAP_PIN_OFF_WAKEUPENABLE,
		     1, "USB_OTG_ID"),
	/* [-N-C-] kpd_row3 - gpio_175 - NC */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     KPD_ROW3, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN,
		     175, "kpd_row3.nc"),
	/* [-----] kpd_row4 - gpio_176 - TP605 */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_WKUP,
		     ...
		     6, "SYS_DRM_MSEC"),
	/* [-----] fref_clk1_out - gpio_181 - 2M_MCLK */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     FREF_CLK1_OUT,
		     OMAP_MUX_MODE0 | OMAP_PIN_INPUT | OMAP_PIN_OFF_OUTPUT_LOW,
		     181, "2M_MCLK"),
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     SYS_NIRQ2, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP,
		     183, "SYS_nIRQ2"),
...
add_sec_muxtbl_to_list(SEC_MACHINE_ESPRESSO, 0, muxtbl);
